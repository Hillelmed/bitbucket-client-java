...
import io.github.hillelmed.bitbucket.client.domain.repository.ProjectKey;
...
public class RepositoryApiLiveTest extends BaseBitbucketApiLiveTest {
    ...
    public void testForkRepository() {
        ...
        final Repository repository = api().fork(projectKey, repoKey, new ForkRepository(forkedRepoName, new io.github.hillelmed.bitbucket.client.domain.repository.ProjectKey(projectKey))).getBody();
        assertThat(repository).isNotNull();
